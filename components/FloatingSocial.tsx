...
export default function FloatingSocial() {
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/amishaalazis',
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/amishaalazis',
    ...
    {
      name: 'Instagram',
      url: 'https://instagram.com/amishaalazis',
      ...
      {socialLinks.map((social, index) => (
        ...
        >
          <a 
            ...
            // Efek Glassmorphism: blur, border transparan, dan bayangan
            className="flex items-center justify-center w-12 h-12 rounded-full bg-[#FFF9F5]/70 backdrop-blur-md border border-[#FF6B4A]/20 text-slate-500 hover:text-[#FF6B4A] hover:bg-white shadow-sm hover:shadow-md transition-all duration-300"
          >
