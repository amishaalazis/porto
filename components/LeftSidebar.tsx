  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mt-6 flex items-center gap-4 lg:hidden">
          <a
            href="https://github.com/amishaalazis"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 text-slate-500 hover:text-[#FF6B4A] hover:bg-[#FF6B4A]/10 transition-colors"
          >
          ...
          <a
            href="https://instagram.com/amishaalazis"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 text-slate-500 hover:text-[#FF6B4A] hover:bg-[#FF6B4A]/10 transition-colors"
          >
